...
namespace BachHoaXanh
{
    public class ExcelExport
    {
        ...
        public const string T_bangdiem = "bangdiem";
        #endregion
        ...
        private void BuildReplacerCurrentDate(ref Dictionary<string, string> pReplacer)
        {
            if (pReplacer != null)
            {
                ...
                pReplacer.Add("%TenNV", nv.LayTenNV(Form1.TenDN));
                pReplacer.Add("%TenNV1", nv.LayTenNV(Form1.TenDN));
        ...
        private MemoryStream GetTemplateStream(string viewName)
        {
            ...
            switch (viewName)
            {
                ...
                case T_bangdiem:
                    ...
                    arrByte = File.ReadAllBytes("bangdiem.xls").ToArray();
                    break;
                #endregion
            }
            // Get stream
        ...
        //public bool ExportDiem(List<Diem> dataSource, ref string fileName, bool isPrintPreview)
        //{
        //    // Check if data is null
        //    if (dataSource == null || (dataSource != null && dataSource.Count == 0))
        //    {
